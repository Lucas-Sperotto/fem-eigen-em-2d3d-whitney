...
![Figura 3. Fluxograma da solução via FEM.](figura3.png)
...
![Figura 4. Geometria de guia de onda retangular.](figura4.png)
...
![Figura 6. Seção transversal de guia de onda circular.](figura6.png)
...
![Figura 8. Seção transversal de linha coaxial.](figura8.png)
...
- As legendas das figuras 3, 4, 6 e 8 foram restauradas para manter a rastreabilidade entre texto e imagem ao longo da subseção de exemplos.
