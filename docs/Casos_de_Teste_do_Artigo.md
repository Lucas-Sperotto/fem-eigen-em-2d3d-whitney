...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 2.1 | `HELM10` | Guia de onda retangular homogêneo | Retangular com `a_r/b_r = 2` | Números de onda de corte `k_c` e campos modais | Figura 4, Tabela 1, Figura 5 | `400` triângulos | `./build/helm10_rect --ar-m 1.0 --nx 10 --ny 20 --nmodos 10` |
| 2 | 2.1 | `HELM10` | Guia de onda circular homogêneo | Circular com raio unitário | Números de onda de corte `k_c` e campos modais | Figura 6, Tabela 2, Figura 7 | `200` triângulos | `./build/helm10_circle --nr 8 --nt 15 --nmodos 10` |
| 3 | 2.1 | `HELM10` | Linha coaxial homogênea | Coaxial com `r_2/r_1 = 4` | Números de onda de corte `k_c` e campos TE/TM superiores | Figura 8, Tabela 3, Figura 9 | `340` triângulos | `./build/helm10_coax --nr 10 --nt 17 --nmodos 10` |
| 4 | 2.2.1 | `HELMVEC` | Guia de onda retangular vetorial | Retangular com ar e `a_r/b_r = 2` | Números de onda de corte `k_c` para modos TE/TM | Figura 4, Tabela 4 | `400` triângulos | `./build/edge_rect --nx 10 --ny 20 --nmodos 10` |
| 5 | 2.2.1 | `HELMVEC` | Guia de onda circular vetorial | Circular com ar e raio unitário | Números de onda de corte `k_c` para modos TE/TM | Tabela 5 | `200` triângulos | `./build/edge_circle --nr 8 --nt 15 --nmodos 10` |
| 6 | 2.2.2 | `HELMVEC1` | Guia de onda retangular misto | Retangular com ar e `a_r/b_r = 2` | Números de onda de corte `k_c` nas formulações `E` e `H` | Figura 4, Tabela 6 | `400` triângulos | `./build/mixed_rect --nx 10 --ny 20` |
| 7 | 2.2.2 | `HELMVEC1` | Guia de onda circular misto | Circular com ar e raio unitário | Números de onda de corte `k_c` nas formulações `E` e `H` | Tabela 7 | `200` triângulos | `./build/mixed_circle --nr 8 --nt 15` |
| 8 | 2.2.3 | `HELMVEC2` | Guia de onda quadrado parcialmente preenchido | Guia quadrado parcialmente preenchido com `beta = 10` | Primeiros `10` números de onda | Figura 11, Tabela 8 | `20x20` (`800` triângulos) | `./build/helmvec2_rect --beta 10 --nx 20 --ny 20` |
| 9 | 2.2.4 | `HELMVEC3` | Dispersão em guia retangular parcialmente preenchido, exemplo 1 | `b_r/a_r = 0.45`, `d/a_r = 0.5`, `\varepsilon_r = 2.45` | Razão `beta/k_0` | Figura 12, Tabela 9 | `100` triângulos | `./build/helmvec3_fig12_rect --nx 10 --ny 5` |
| 10 | 2.2.4 | `HELMVEC3` | Dispersão em guia retangular parcialmente preenchido, exemplo 2 | `b_r/a_r = 0.45`, `\varepsilon_r = 2.45`, vários valores de `d/a_r` | Ramos de dispersão `beta/k_0` | Figura 13, Tabela 10 | `100` triângulos | `./build/helmvec3_fig13_rect --d-over-a-preview 0.20 --nx 10 --ny 5` |
