...
| R5 | 9, 10 | `HELMVEC3` | `helmvec3_rect` | `src/helmvec3/main_helmvec3_rect.cpp` | `tp3485::build_eq136_helmvec3_system_E(...)` | `build_coupled_beta_system_E(...)` | `generalized_eigs_real_vec(...)` | `beta_ratio_candidates_from_k0(...)`, `match_ratio_to_reference(...)`, `trace_ratio_branch(...)` |
| R6 | 11, 12, 13, 14 | `FEM3D0` | `fem3d0_rect` | `src/fem3d0/main_fem3d0_rect.cpp` | `tp3485::build_eq178_fem3d_system_dense(...)` | `build_helm3d_edge_system(...)` | `generalized_eigs_sym_vec(...)` | `fem3d::first_positive_k0(...)`, `fem3d::match_by_reference_with_degeneracy(...)`, `fem3d::print_table_compare(...)` |
| R7 | 11, 12, 13, 14 | `FEM3D1` | `fem3d1_rect` | `src/fem3d1/main_fem3d1_rect.cpp` | `tp3485::build_eq178_fem3d_system_sparse(...)` | `build_helm3d_edge_system_sparse(...)` | `generalized_eigs_sym_vec(...)` | `fem3d::first_positive_k0(...)`, `fem3d::match_by_reference_with_degeneracy(...)`, `fem3d::print_table_compare(...)` |
...
| 9 | Dispersão, Figura 12 / Tabela 9 | `helmvec3_rect` | `src/helmvec3/main_helmvec3_rect.cpp` | `helmvec2::parse_coupled_cli_options(...)` | `make_rect_mesh(...)` + `helmvec23::eps_step_y(...)` | `tp3485::build_eq136_helmvec3_system_E(...)` | `build_coupled_beta_system_E(...)` | `src/helmvec3/main_helmvec3_rect.cpp`, `src/helmvec2/helmvec2_coupled_system.cpp`, `src/helmvec2/helmvec23_shared.hpp` |
| 10 | Dispersão, Figura 13 / Tabela 10 | `helmvec3_rect` | `src/helmvec3/main_helmvec3_rect.cpp` | `helmvec2::parse_coupled_cli_options(...)` | `make_rect_mesh(...)` + `helmvec23::eps_step_x(...)` | `tp3485::build_eq136_helmvec3_system_E(...)` | `build_coupled_beta_system_E(...)` | `src/helmvec3/main_helmvec3_rect.cpp`, `src/helmvec2/helmvec2_coupled_system.cpp`, `src/helmvec2/helmvec23_shared.hpp` |
