...
![Figura 1. Geometria do problema.](../figs/figura1.png)
...
![Figura 2. Elemento triangular simples.](../figs/figura2.png)
...
![Figura 3. Fluxograma da solução via FEM.](../figs/figura3.png)
...
![Figura 4. Geometria de guia de onda retangular.](../figs/figura4.png)
...
![Figura 6. Seção transversal de guia de onda circular.](../figs/figura6.png)
...
![Figura 8. Seção transversal de linha coaxial.](../figs/figura8.png)
...
### Leitura cruzada com o CSV do HELM10

- Para estudar como a saída numérica do projeto organiza os resultados desta seção, ver:
  [HELM10_CSV_Modos_Referencia.md](../HELM10_CSV_Modos_Referencia.md)
- Para estudar especificamente o matching modal por correlação de massa e a
  interpretação de `rho_abs`, ver a seção correspondente dentro de:
  [HELM10_CSV_Modos_Referencia.md](../HELM10_CSV_Modos_Referencia.md)
- Para estudar o arquivo nodal ponto a ponto, ver:
  [HELM10_CSV_Campos_Referencia.md](../HELM10_CSV_Campos_Referencia.md)
- Para estudar o script que transforma esses CSVs em figuras de inspeção
  visual, ver:
  [HELM10_Imagens_Referencia.md](../HELM10_Imagens_Referencia.md)
- Esse glossário explica, coluna por coluna, o CSV de modos gerado pelos executáveis
  `helm10_rect`, `helm10_circle` e `helm10_coax`.
- O glossário de campos explica o CSV nodal associado a cada linha do
  `modes.csv`, ligado pela coluna `fields_csv_file`.

---

## Navegação

Anterior: [2. Problemas Bidimensionais](2_Problemas_Bidimensionais.md) | Índice: [README.md](../README.md) | Próximo: [2.2 Guias de Onda Não Homogêneos](2.2_Guia_Nao_Homogeneo.md)
