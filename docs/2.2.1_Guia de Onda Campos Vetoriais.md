...
![Figura 10. Configuração de elementos de aresta tangenciais.](figura10.png)
...
- A legenda da Figura 10 foi restaurada para deixar explícita a configuração geométrica usada na definição dos elementos de aresta tangenciais.
