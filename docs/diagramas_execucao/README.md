...
Esta pasta funciona como caderno de navegacao da colecao de diagramas-base do projeto. Ela nao substitui os diagramas principais em `docs/`; ela organiza a leitura deles como uma trilha unica, do problema mais simples ao mais complexo.
...
Este caderno existe para reduzir a friccao de leitura. Os diagramas principais continuam na raiz de `docs/` para ficar perto da teoria e dos demais materiais, mas esta pasta concentra a navegacao orientada para implementacao.
