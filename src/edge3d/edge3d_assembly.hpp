...
/* cavidades. Implementa a formulacao vetorial 3D da Secao 3.1. No artigo,    */
/* este ponto corresponde a montagem global da Eq. (178).                     */
/* ENTRADA: mesh: const Mesh3D &; eps_r: double; mu_r: double; backend:       */
...
/* (triangulo inferior). Implementa a formulacao vetorial 3D da Secao 3.1 e   */
/* continua representando a mesma Eq. (178), apenas com outro armazenamento.  */
/* ENTRADA: mesh: const Mesh3D &; bc: Edge3DBC; eps_r_tet: const              */
/* std::vector<double> &; mu_r_tet: const std::vector<double> &; backend:     */
/* ElementAssemblyBackend.                                                    */
